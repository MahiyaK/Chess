...
function updateAdvantage() {
  ...
  if (globalSum > 0) {
    scoreDisplay.innerText = 'Black is winning by ' + globalSum + ' points.';
  } else if (globalSum < 0) {
    scoreDisplay.innerText = 'White is winning by ' + (-globalSum) + ' points.';
  } else {
    scoreDisplay.innerText = 'The game is even.';
  }
...
// Whenever you want to update the score
updateAdvantage();
